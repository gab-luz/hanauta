...
class NotificationCenter(
    ...
    def _build_overview_page(self) -> QWidget:
        ...
        top_row.addWidget(left, 10)
        top_row.addWidget(right, 11)
        content.addLayout(top_row, 1)

        utility_row = QHBoxLayout()
        utility_row.setContentsMargins(0, 0, 0, 0)
        utility_row.setSpacing(12)
        utility_row.addWidget(self._build_phone_card(), 5)
        utility_row.addWidget(self._build_home_assistant_card(), 9)
        utility_row.addWidget(self._build_game_carousel_card(), 10)
